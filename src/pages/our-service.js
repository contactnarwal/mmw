...
const OurService = () => {
  const data = useStaticQuery(graphql`
    query {
      imageOne: file(relativePath: { regex: "/web-design-service.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
      ...
      imageTwo: file(relativePath: { regex: "/online-marketing.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
      ...
      imageThree: file(relativePath: { regex: "/web-email-hosting.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
      ...
      imageFour: file(relativePath: { regex: "/Ecommerce.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
      ...
      imageFive: file(relativePath: { regex: "/seo-service.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
      ...
      imageSix: file(
        relativePath: { regex: "/Content-Marketing-Online-Conc.jpg/" }
      ) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
      ...
      imageSeven: file(relativePath: { regex: "/social-service-mmw.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
      ...
      imageEight: file(relativePath: { regex: "/ppc.jpg/" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
      ...
      <ServiceContainer>
        ...
        <Row css={{ marginTop: "60px" }}>
          <Col lg="6" css={{ paddingLeft: "50px" }}>
            ...
            <BORDER />
            <P>
              Marketing is the backbone of any business and none can shrug off
              its value. This certainly is our competitive advantage. To build a
              rewarding marketing program and maintaining it thereafter, several
              tools exist online. But a few of them are search engine
              optimization campaigns, pay-per-click, banner advertising, email
              marketing, etcetera.
            </P>
        ...
        <Row css={{ marginTop: "60px" }}>
          ...
          <Col lg="6">
            ...
            <BORDER />
            <P>
              Since the competition is neck and neck, and businesses have so
              many tasks to perform, they are hiring web and email hosting firms
              for their convenience. There is a belief that registering a domain
              name is just enough, to begin with, a website.
            </P>
            <P>
              But, it entirely contradicts with the fact that a domain is just
              like your name, a name to address you. To get a site active and
              live on the internet, hosting a website is of utmost need.
            </P>
            <p>
              <ReadMore>Read More...</ReadMore>
            </p>
        ...
        <Row css={{ marginTop: "60px" }}>
          <Col lg="6" css={{ paddingLeft: "50px" }}>
            ...
            <P>
              ...
              choose online shopping as the most convenient way. There are
              several companies which have a web presence for trading their
        ...
        <Row css={{ marginTop: "60px" }}>
          ...
          <Col lg="6">
            ...
            <P>
              ...
              marketing channels to endorse website exposure via higher
              visibility in search engines. It is carried out to gain a surge in
              the website traffic. Search Engine Optimization can be performed
              in two ways. Either you can optimize by yourself or hire a search
              engine optimization company for doing it for me. Here, choosing
              the former option may not be promising enough for satisfactory
              outcomes, while choosing the latter is the best choice to get a
              higher rank for your website on search engines, like Google,
              etcetera.
            </P>
            <p>
              <ReadMore>Read More...</ReadMore>
        ...
        <Row css={{ marginTop: "60px" }}>
          <Col lg="6" css={{ paddingLeft: "50px" }}>
            ...
            <P>
              ...
              tactics of content writing, to educate your audience in an
              efficient manner.
            </P>
            ...
            <P>
              A good content directly communicates with your online customers.
              In such a scenario, hiring a content writing company can be a boon
              for your business.
            </P>
            <p>
              <ReadMore>Read More...</ReadMore>
        ...
        <Row css={{ marginTop: "60px" }}>
          ...
          <Col lg="6">
            ...
            <P>
              ...
              growing your brand. Globally, social media is one of the fastest
              growing industries. And, to increase your brand’s reach and
              visibility, you ought to make the most out of it.
            </P>
            <P>
        ...
        <Row css={{ marginTop: "60px" }}>
          <Col lg="6" css={{ paddingLeft: "50px" }}>
            ...
            <P>
              ...
              attract maximum customers. The best part although is, there are
              many ways to enhance your business online.
            </P>
            ...
            <P>
              ...
              Website knows how to carry out Pay Per Click and how is it going
              to help you. Whatever time suits you, just contact us and we will
              more than happy to address your queries.
            </P>
